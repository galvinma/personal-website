        ...
        <div className="content">
          <div className="landing-about-container">
            <div className="general-text-container">
              ...
              <div className="about-text">
                <div className="body1">I’m a healthcare professional living in Boston, Massachusetts. ⛵⚾⚕️</div>
              </div>
              <div className="about-text">
              ...
              <div className="about-text">
                <div className="body1">Thank you for visiting my website. While you are here be sure to checkout out my <Link class="nav-link unstyled-link" to="/photography">photography</Link> and <a class="nav-link unstyled-link" href="/MatthewGalvin_Resume_Public.pdf" target="_blank" rel="noopener noreferrer">resume</a>.
                </div>
              </div>
                
              <div className="about-text">
                  <div className="body1">I am always looking for new and exciting projects; If you would like to work together, or have any questions about my work, please <a className="unstyled-link" href="mailto:matthewrgalvin@gmail.com">reach out</a>.
                  </div>
              </div>
            </div>
          </div>
